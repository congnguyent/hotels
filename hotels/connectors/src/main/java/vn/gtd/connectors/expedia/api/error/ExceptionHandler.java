package vn.gtd.connectors.expedia.api.error;
...
import vn.gtd.connectors.expedia.aggregates.continent.ContinentAggregate;
import vn.gtd.connectors.expedia.utils.RequestParamUtil;
...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(ContinentAggregate.InsufficientBalanceException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public String insufficientBalance(ContinentAggregate.InsufficientBalanceException e) {
        return e.getMessage();
    }
