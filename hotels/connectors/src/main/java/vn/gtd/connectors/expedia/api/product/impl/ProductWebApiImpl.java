package vn.gtd.connectors.expedia.api.product.impl;
...
import vn.gtd.connectors.expedia.api.product.AddProductRequest;
import vn.gtd.connectors.expedia.api.product.ProductWebApi;
import vn.gtd.connectors.expedia.command.product.ProductCommandFactory;
...
public class ProductWebApiImpl implements ProductWebApi {
    ...
    @Override
    public CompletableFuture<String> addProduct(@RequestBody AddProductRequest newProduct) {
